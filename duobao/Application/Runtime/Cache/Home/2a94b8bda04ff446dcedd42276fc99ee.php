...
<head>
	...
	<link href="http://1qjx.com/Public/public1/index/css/common.css" rel="stylesheet">
	<link href="http://1qjx.com/Public/public1/index/css/detail.css" rel="stylesheet">
</head>
        ...
        <div class="g-wrap">
                    ...
                    <div class="w-goods-info">
                        ...
                        <p class="w-goods-period">期号：<?php echo ($goods["issue"]); ?></p>
                            ...
                            <!-- <div class="m-detail-userCodes">
	                            <p>您参与了：<span class="txt-red">8</span>人次</p>
	                            <p class="codes">夺宝号码：
            ...
            <div class="g-wrap-bd">
                <div class="m-detail-more">
                    ...
                    <a href="<?php echo u('User/lucky',array('id' => $goods['id']));?>" class="w-bar">我的幸运码<span class="w-bar-ext"><b class="ico-next"></b></span></a>

                    <a href="<?php echo u('Lucky/way');?>" class="w-bar">幸运号计算方式<span class="w-bar-ext"><b class="ico-next"></b></span></a><?php endif; ?>
                </div>
                <div class="m-detail-record">
                    ...
                    <div class="m-simpleFooter m-detail-buy">
                        <div data-pro="text" class="m-simpleFooter-text" style="text-align:center">
                            <a id="quickBuy" class="w-button w-button-main" href="<?php echo u('Pay/join',array('id' => $goods['id']));?>">立即参与</a>
                        </div>
