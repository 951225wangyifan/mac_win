...
<body>
    <div class="m-pay-order">
        ...
        <div data-pro="submit" class="m-pay-order-submit"><a href="<?php echo u('Pay/go_pay',array('order_id' => $goods['order_id']));?>"><button id="pro-view-20" class="w-button w-button-main w-button-l">确认支付</button></a></div>
    </div>
