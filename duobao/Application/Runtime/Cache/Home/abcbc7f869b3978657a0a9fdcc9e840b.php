		    ...
		    <div id="pro-view-1">
		    	...
		    	<?php if(is_array($goods_past)): foreach($goods_past as $k=>$goods): ?><li id="pro-view-2" class="w-record m-winRecord-revealed">
		    			<div class="w-record-title">
		    				<a href="<?php echo u('Goods/past_details',array('issue' => $goods['issue']));?>">期号：<?php echo ($goods["issue"]); ?> ( 揭晓时间：<?php echo ($goods["publish_time"]); ?> )
		    				<?php if($goods["user"] == ''): ?>&nbsp;<b style="color:red;">尚未开奖</b><?php endif; ?>
		    				</a>
		    			</div>
