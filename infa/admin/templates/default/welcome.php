...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['dashboard_wel_system_info'];?><!--<?php echo $lang['dashboard_wel_lase_login'].$lang['nc_colon'];?><?php echo $output['admin_info']['admin_login_time'];?>-->：bbs.54ak.com提供免费升级服务。</h3>
    </div>
  </div>
  ...
  <div class="info-panel">
    ...
    <dl class="system">
      <dt>
        ...
        <div id="system-info">
          <ul>
            <li>有益网络shopnc <?php echo $lang['dashboard_welcome_version'];?><span>2015111版</span></li>
      ...
      <dd>
        <ul>
          <li class="w50pre none"><a href="http://bbs.54ak.com" target="_blank">官方网站<sub></sub></a></li>
          <li class="w50pre none"><a href="http://bbs.54ak.com" target="_blank">官方论坛<sub></sub></a></li>
        </ul>
      </dd>
    </dl>
    <div class="clear"></div>
