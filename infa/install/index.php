...
$html_title = 'bbs.54ak.com 有益网络电商系统 安装程序';

$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>bbs.54ak.com 有益网络电商系统 安装程序</h5>
      <h2>系统安装向导</h2>
    </div>
    <div class="version">版本: 2015.11.11</div>
  </div>
</div>
...
$html_footer = <<<EOF
<div class="footer">
  <h6><a href="http://bbs.54ak.com" target="_blank">程序来源于 有益网络 bbs.54ak.com</a></h6>
</div>
EOF;
...
function step3(&$install_error,&$install_recover){
    ...
    if ($_POST['demo_data'] == '1'){
        $db->query("UPDATE {$db_prefix}store SET `live_store_name`='好商城V3',`live_store_address`='中国',`live_store_tel`='400-80000000',`live_store_bus`='33路' WHERE `store_id`=1");
