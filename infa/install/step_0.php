...
<div class="main">
  <div class="text-box" id="text-box">
    <div class="license">
      <h1>有益网络电商系统安装协议</h1>
      <p>感谢你选择有益网络电商系统。本系统由好商城根据网域天创版本所改进版本！只用于学习交流使用。</p>
      <p>
用户须知：本协议是您与有益网络之间关于您安装使用有益网络提供的有益网络电商系统及服务的法律协议。无论您是个人组织、盈利与否、用途如何（包括以学习和研究为目的），均与有益网络无关！有益网络只提供相关技术服务！不负责任何商业责任！还请知悉。</p>
      <p></p>
      <p align="right">有益网络技术交流中心</p>
    </div>
  </div>
...
<div class="footer">
 <h6><a href="http://bbs.54ak.com" target="_blank">程序来源于 bbs.54ak.com</a></h6>
</div>
